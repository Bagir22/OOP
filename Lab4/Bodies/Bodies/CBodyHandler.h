...
const std::string CompoundMode = "\tEnable\\Disable compound: 5\n";
const std::string MaxMassCommand = "Max mass body: 6\n";
const std::string MinWeightCommand = "Min weight: 7\n";
const std::string PrintBoidesCommand = "Print bodies: 8\n";
const std::string ExitCommand = "Exit: 9\n";
